...
track = {
    'covid': ['covid', 'vaccine', 'moderna', 'seconddose', 'vaccinated', 'pfizer', 'astrazeneca'],
    'football': ['portugal', 'ronaldo', 'fernando', 'danilo', 'renato', 'william', 'havertz', 'champ', 'semedo', 'jota',
                 'benzema', 'portugues', 'hungary'],
    'june': ['juneteenth', 'juneteenthcelebration', 'juneteenth2021', 'fathersday', 'father', 'dad', 'happyfathersday'],
    'pride': ['pride', 'pridemonth', 'gay', 'lgbtq', 'love', 'loveislove', 'queer', 'biseexual', 'lesbian', 'lgbtpride',
              'trans'],
}
